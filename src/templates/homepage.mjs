...
function botanicalMark() {
  return `<svg class="home-botanical" viewBox="0 0 140 259" width="140" height="259" aria-hidden="true"><g fill="none" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round"><path d="M70 250V100"/><path d="M70 176C46 163 34 138 46 116c12 20 18 40 24 60z"/><path d="M70 210c24-12 36-40 24-62-12 20-18 42-24 62z"/><path d="M70 100V26"/><ellipse cx="58" cy="96" rx="7" ry="4.2" transform="rotate(-28 58 96)"/><ellipse cx="82" cy="90" rx="7" ry="4.2" transform="rotate(28 82 90)"/><ellipse cx="57" cy="80" rx="6.4" ry="3.8" transform="rotate(-24 57 80)"/><ellipse cx="83" cy="74" rx="6.4" ry="3.8" transform="rotate(24 83 74)"/><ellipse cx="59" cy="64" rx="5.8" ry="3.4" transform="rotate(-20 59 64)"/><ellipse cx="81" cy="58" rx="5.8" ry="3.4" transform="rotate(20 81 58)"/><ellipse cx="62" cy="48" rx="5" ry="3" transform="rotate(-16 62 48)"/><ellipse cx="78" cy="42" rx="5" ry="3" transform="rotate(16 78 42)"/><ellipse cx="70" cy="30" rx="4.2" ry="2.8"/></g></svg>`;
}
