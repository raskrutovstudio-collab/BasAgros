...
Производный технический манифест маршрутов. Не заменяет утверждённую SEO-карту.

## Актуальная SEO-карта

- Файл: `docs/seo/BAS_Agros_SEO_karta_Kazakhstan_V4_1_2_CLEAN_FINAL_2026-09-11.xlsx`
- Версия внутри книги: `V4.2.0 BUSINESS ARCHITECTURE`, 11.09.2026
- Основной лист: `02_SEO_MAP`, диапазон `A1:AL134`
- Обнаружено: 131 страница, включая 73 подтверждённые товарные страницы
- Статус: основной источник для следующей миграции структуры сайта

Текущий `src/data/seo-routes.json` и описанная ниже нормализация ещё относятся к V3.7.1. Они не заменяются автоматически: перенос 131 маршрута, новой иерархии и метаданных из V4.2.0 выполняется отдельной задачей с проверкой редиректов и сохранением действующих страниц.

## Источник текущего технического манифеста (legacy)
