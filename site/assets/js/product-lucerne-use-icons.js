(() => {
  ...
  if (partyInfographic && !partyInfographic.querySelector('.lucerne-party-visual')) {
    ...
    visual.innerHTML = '<img src="/assets/img/products/lucerne-party-quality.webp?v=20260915-18" width="720" height="900" alt="Контроль качества партии семян люцерны" loading="lazy" decoding="async">';
