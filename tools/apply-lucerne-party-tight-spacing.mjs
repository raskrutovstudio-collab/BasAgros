...
html = html.replace('/assets/css/product.css?v=20260828-14', '/assets/css/product.css?v=20260831-3');
...
console.log('Lucerne party icon removed; party spacing and use-section heading layout tightened.');
