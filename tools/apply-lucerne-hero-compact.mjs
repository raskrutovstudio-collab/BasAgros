...
const lucerneHeroImage = '<img src="/assets/img/products/lucerne-field-hero.webp" width="640" height="427" alt="Поле цветущей люцерны" fetchpriority="high" decoding="async">';
...
html = html.replace('/assets/css/product.css?v=20260828-12', '/assets/css/product.css?v=20260828-13');
...
const mobileFactsMarker = '/* Lucerne mobile facts: keep values on one line. */';
if (!css.includes(mobileFactsMarker)) {
  css += `\n${mobileFactsMarker}\n@media (max-width: 47.99rem) {\n  .page-product .product-facts > div {\n    grid-template-columns: 1.35rem minmax(0, 1fr);\n    gap: .08rem .45rem;\n    padding: .8rem .72rem;\n  }\n  .page-product .product-facts svg {\n    width: 1.2rem;\n    height: 1.2rem;\n  }\n  .page-product .product-facts dd {\n    white-space: nowrap;\n    font-size: .9375rem;\n    line-height: 1.25;\n  }\n}\n`;
  fs.writeFileSync(cssPath, css, 'utf8');
}

console.log(`Lucerne hero image rebuilt from supplied image (${heroImageBuffer.length} bytes) and applied.`);
