...
const contactsBlock = `<div id="contacts"><h2>Контакты</h2><p><a href="https://wa.me/77059608987" class="home-footer-phone home-footer-contact-link" target="_blank" rel="noopener noreferrer" aria-label="Написать в WhatsApp на номер 8 705 960 89 87">${whatsappIcon}<span class="home-footer-contact-copy"><strong class="home-footer-contact-value">WhatsApp</strong></span></a></p><p><a href="tel:+77051940212" class="home-footer-phone home-footer-contact-link" aria-label="Позвонить по корпоративным клиентам: 8 705 194 02 12">${phoneIcon}<span class="home-footer-contact-copy"><small class="home-footer-contact-role">Корпоративным клиентам</small><strong class="home-footer-contact-value">8 705 194 02 12</strong></span></a></p><p><a href="tel:+77051113242" class="home-footer-phone home-footer-contact-link" aria-label="Позвонить в отдел продаж: 8 705 111 32 42">${phoneIcon}<span class="home-footer-contact-copy"><small class="home-footer-contact-role">Отдел продаж</small><strong class="home-footer-contact-value">8 705 111 32 42</strong></span></a></p><p><a href="mailto:Basagros@mail.ru" class="home-footer-phone home-footer-contact-link" aria-label="Написать на электронную почту Basagros@mail.ru">${mailIcon}<span class="home-footer-contact-copy"><small class="home-footer-contact-role">Почта</small><strong class="home-footer-contact-value">Basagros@mail.ru</strong></span></a></p><p class="home-footer-contact-note">Работаем с хозяйствами по Казахстану.</p><a href="#request" class="home-footer-cta" data-home-modal-intent="commercial_offer">Получить коммерческое предложение →</a></div>`;
