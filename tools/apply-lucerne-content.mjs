...
html = html.replace(
  ...
  'Семена люцерны для сельскохозяйственных хозяйств с поставкой по Казахстану и странам СНГ.<span class="product-lead-price">Базовая цена — от 2 580 000 ₸ за тонну; актуальное наличие и итоговые условия уточняются по заявке.</span>'
);
html = html.replace(
