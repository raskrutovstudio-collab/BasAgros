...
html = html.replace(
  ...
  '<p><strong>Люцерна посевная (Medicago sativa L.) — многолетняя бобовая кормовая культура.</strong> В сельском хозяйстве её используют для заготовки сена и сенажа, кормовых посевов и пастбищных систем. Культура формирует глубокую корневую систему и применяется в многолетних кормовых севооборотах.</p><p>Ниже приведены подтверждённые варианты фасовки BAS Agros и справочные агрономические показатели для семян люцерны. Справочные значения помогают оценить товар до запроса документов, но не заменяют паспорт или анализ конкретной партии.</p>'
);

const specsPattern = /<dl class="product-spec-list">[\s\S]*?<\/dl>/;
const specs = `<dl class="product-spec-list">
      <div><dt>Наименование культуры</dt><dd>Люцерна посевная</dd></div>
      <div><dt>Научное название</dt><dd>Medicago sativa L.</dd></div>
      <div><dt>Тип культуры</dt><dd>Многолетняя бобовая кормовая культура</dd></div>
      <div><dt>Основное использование</dt><dd>Сено, сенаж, кормовые и пастбищные посевы</dd></div>
      <div><dt>Чистота семян</dt><dd>Справочный ориентир для сертифицированных семян: не менее 99%</dd></div>
      <div><dt>Всхожесть + твёрдые семена</dt><dd>Справочный ориентир: не менее 85%</dd></div>
      <div><dt>Инертная примесь</dt><dd>Справочный ориентир: не более 1%</dd></div>
      <div><dt>Масса 1000 семян</dt><dd>Ориентировочно 1,6–2,2 г; зависит от сорта и партии</dd></div>
      <div><dt>Ориентир нормы высева</dt><dd>Около 13,5–16,8 кг чистых жизнеспособных семян на гектар для рядового посева; корректируется по качеству семян и технологии</dd></div>
      <div><dt>Предпочтительная реакция почвы</dt><dd>Ориентир pH 6,3–7,0; важны хороший дренаж и отсутствие длительного переувлажнения</dd></div>
      <div><dt>Ориентир глубины посева</dt><dd>Примерно 0,6–1,3 см на более тяжёлых почвах; на песчаных глубина может быть больше</dd></div>
...
html = html.replace(
  ...
  '<div><p class="product-eyebrow">Характеристики</p><h2 id="product-specs-title">Основные показатели семян люцерны</h2><p>Показатели чистоты и всхожести ниже приведены как справочные ориентиры по стандартам сертифицированных семян люцерны из открытых отраслевых источников. Для заказа приоритет имеют фактические данные конкретной партии BAS Agros.</p></div>'
);
...
console.log('Lucerne content expanded: reference specifications, packaging, agronomy and storage blocks applied.');
